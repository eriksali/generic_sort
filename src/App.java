...
public class App {
    ...
    public static <T extends Comparable<T>> void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            System.out.println("\nPlease input the grade data type (choose Integer, Float, or Double): ");
            String typeName = scanner.next();
            ArrayList<Student<T>> arrayList = createRandomArray(arrayLength, typeName);

            System.out.println(
                    "\nWould you like to use bubble sort or merge sort? Enter \"bubble\" for bubble sort or \"merge\" for merge sort:");
            String bubbleMergeInput = scanner.next();
            boolean bubbleMerge;
            if (bubbleMergeInput.equalsIgnoreCase("bubble")) {
                bubbleMerge = true;
            } else if (bubbleMergeInput.equalsIgnoreCase("merge")) {
                bubbleMerge = false;
            } else {
                System.out.println(
